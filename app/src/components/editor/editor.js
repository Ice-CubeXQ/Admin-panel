...
export default class Editor extends Component {
  ...
  open(page, cb) {
    ...
    axios
      ...
      .then(() => this.iframe.load("../jaji1314l.html"))
  ...
  restoreBackup(e, backup) {
    ...
    UIkit.modal
      .confirm("Вы действительно хотите восстановить эту страницу из этой резервной копии? Все несохраненные данные будут потеряны!", { labels: { ok: "Восстановить", cancel: "Отмена" } })
      .then(() => {
        this.isLoading();
